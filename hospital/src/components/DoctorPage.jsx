...
const DoctorPage = () => {
  ...
  const doctor =
    doctorData['CEO - Director'][doctorId] || doctorData['Research & Development'][doctorId];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        'https://swamihospital.onrender.com/api/appointments',
        {
          method: 'POST',
    ...
    <>
      ...
      <main>
        ...
        >
          ...
          <motion.div className="doctors-bottom">
            <motion.div
            ...
            >
              <h2>Get in touch</h2>
              <h4>
                Have a question or need to book a consultation? Send us a
